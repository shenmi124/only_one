...
function exponentialFormat(num, precision, mantissa = true) {
    ...
    e = (e.gte(1e9) ? formatScientific(e, 3) : (e.gte(10000) ? commaFormat(e, 0) : e.toStringWithDecimalPlaces(0)))
    if (mantissa)
